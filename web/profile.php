    ...
    <div class="col-lg-8">
      ...
      <div class="col-12 p-0" style="margin-bottom: 70px;">
        <div class="card d-flex align-items-center">
          <div id="coverIamgeUser" <?= $_SESSION["username"] == $account["username"] ? 'onclick="$(\'#fileCoverImg\').click()"' : "" ?> style="width: 100%;height: 230px;background: #111;background-image : url('/app/media/imgs/<?= $account["coverImg"] ?>');background-size: 100%;background-position: center;border-radius: 10px;">
          </div>
          <div class="position-absolute top-100 start-50 translate-middle">
            ...
            <img <?= $_SESSION["username"] == $account["username"] ? 'onclick="$(\'#fileAvatarImg\').click()"' : "" ?> id="imageAvatras" style="width:130px;height: 130px;border-radius: 50%;border: 1px solid #fff;" src="/app/media/imgs/<?= $account["avatar"] ?>">
          </div>
        </div>
      </div>
