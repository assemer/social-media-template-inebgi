...
function widgetPost($post)
{
    ...
    <div class="content">
      ...
      <img class="ui avatar image" src="/app/media/imgs/'.(empty($MGuser->searchUserByUsername($post["author"])["avatar"]) ? "matthew.png" : $MGuser->searchUserByUsername($post["author"])["avatar"] ).'"> <a href="profile.php?usr='.$post["author"].'">'.$post["author"].'</a>
    </div>
