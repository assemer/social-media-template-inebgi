...
<div class="ui secondary menu w-100 p-1" style="border-radius: 5px;">
 ...
 <!--  <a class="item">
  ...
  <?= 
    !empty($myAccounts) ? '<a href="profile.php?usr='.$myAccounts.'" class="item"><i class="fa fa-user mx-2"></i> '.$myAccounts .' </a>' : '' ?>
  <div class="right menu">
    ...
    <?= 
    !empty($myAccounts) ? '<a class="ui item" href="/app/libs/php/api/user.php?logout=1">log-out <i class="fa fa-arrow-right mx-2"></i></a>' : '<a class="ui item" href="/login.php">log-in <i class="fa fa-arrow-right mx-2"></i></a>' ?>
  </div>
</div>
</div>
