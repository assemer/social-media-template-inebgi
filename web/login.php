                ...
                <div class="card w-100">
                    ...
                    <div class="card-body">
                        <div class="ui form">
                          ...
                          <button class="ui button" type="submit" onclick="loginIntoWeb($('#usrqsdqsd')[0].value,$('#upswqsdqsd')[0].value,$(this))">login</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card w-100">
                    ...
                    <div class="card-body">
                        <form class="ui form register">
                          ...
                          <div class="ui primary button" onclick="registerNewUsers($('#vubcoidfg'),$(this))">Submit</div>
